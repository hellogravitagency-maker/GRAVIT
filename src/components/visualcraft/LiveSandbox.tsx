...
export function LiveSandbox({ state }: LiveSandboxProps) {
 ...
 <div className={`w-full aspect-[4/3] rounded-2xl from-[${state.colorTheme.primary}] to-[${state.colorTheme.secondary}] opacity-80 blur-2xl absolute inset-0`} />
 ...
 <>
 <section className={`flex flex-col items-center justify-center text-center ${sectionPadding} min-h-[70vh] to-[${state.colorTheme.secondary}]/10`}>
