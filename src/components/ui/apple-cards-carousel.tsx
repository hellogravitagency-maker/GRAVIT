            ...
            >
              ...
              <div className="p-8 md:p-14">
                ...
                <div className="aspect-video w-full border border-border overflow-hidden mb-12">
                  <img
                    src={card.src}
                    srcSet={card.src.endsWith('.webp') ? `${encodeURI(card.src.replace('.webp', '-300w.webp'))} 300w, ${encodeURI(card.src.replace('.webp', '-400w.webp'))} 400w, ${encodeURI(card.src.replace('.webp', '-600w.webp'))} 600w, ${encodeURI(card.src.replace('.webp', '-800w.webp'))} 800w, ${encodeURI(card.src)} 1200w` : undefined}
                    sizes={card.src.endsWith('.webp') ? "(max-width: 768px) 100vw, 50vw" : undefined}
                    alt={card.title}
