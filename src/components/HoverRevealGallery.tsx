...
const projects: Project[] = [
  ...
  { id: '05', title: 'ECHO', category: 'Portfolio', image: '/images/editorial_post_2.jpg', link: '/work' },
];
...
export default function HoverRevealGallery() {
 ...
 <div className={cn(
 "absolute inset-0 bg-white/5 transition-opacity duration-500 pointer-events-none -z-10",
 ...
 <span className="block h-[1em] [-webkit-text-stroke:2px_#00F0FF] leading-none italic pr-8 relative z-10">
 {project.title}
 </span>
 </div>
 </h2>
