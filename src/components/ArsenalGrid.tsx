...
export default function ArsenalGrid() {
 ...
 <div className="absolute bottom-0 left-0 w-full h-[1px] bg-white/5 scale-x-0 group-hover:scale-x-100 transition-transform duration-700 ease-out origin-left" />
 </motion.div>
 );
 })}
 </motion.div>
