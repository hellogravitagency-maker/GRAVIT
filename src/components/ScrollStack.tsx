...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  const setupLenis = useCallback(() => {
    // We omit instantiating a new Lenis if useWindowScroll is true to avoid double global lenis instances.
    // Use requestAnimationFrame to poll scroll position and eliminate event lag with smooth scrolling.
    if (useWindowScroll) {
      const loop = () => {
        handleScroll();
